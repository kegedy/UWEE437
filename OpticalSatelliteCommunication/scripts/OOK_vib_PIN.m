function Pb = OOK_vib_PIN(Pmax, Pmin, var_theta, Br, Id, Pback, Rl, Tr,...
n, lambda, Dt, Dr, nt, nr, d, Lil)
...
for theta_r = 0:2*10^-6:10^-4
	...
	for theta_t = 0:2*10^-6:10^-4
		P = P + P_OOK_theta(Pmax, Pmin, Br, Id, Pback, Rl, Tr, n,...
...
%Gives the BER for OOK transmitter and receiver PointingLoss error.
...
function P_OOK = P_OOK_theta(Pmax, Pmin, Br, Id, Pback, Rl, Tr, n,...
lambda, Dt, Dr, nt, nr, d, theta_t, theta_r, Lil)
...
[Xs, varXs, Xns, varXns, SNR] =...
	meanvar_PIN(Pr1, Pr0, 1, Br, Id, Pback, Rl, Tr, n, lambda);
